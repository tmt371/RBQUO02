...
(function () {
    ...
    function handleDiscount(table) {
        ...
        for (let col = 1; col <= 7; col++) {
            ...
            // 假設 bdrive, dbket, motor 分別在第 4、5、6 欄
            const isExcludedColumn = (col === 4 || col === 5 || col === 6);

            const discountedPrice = isExcludedColumn ? originalPrice : originalPrice * discountRate;
            const gst = Math.round(discountedPrice * 0.1 * 100) / 100;
